...
function _getResearchPageInfo(records) {
    if (records.length > 0) {
        ...
        result['Researchers'] = getAllNodesByFieldKey(
            records, 
            'researchers', 
            'Researcher'
        );
        ...
        result['Research Setup Used'] = getAllNodesByFieldKey(
            records,
            'researchSetups',
            'ResearchSetup'
        );
        result['Articles Published'] = getAllNodesByFieldKey(
            records, 
            'articles', 
            'Article'
        );
